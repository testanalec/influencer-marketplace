    ...
    <div className="min-h-screen bg-gray-50">
      <div className="max-w-4xl mx-auto px-4 py-8">
            ...
            <div className="flex items-center gap-4">
              ...
              <div>
                ...
                <div className="flex items-center gap-2 mt-1">
                  ...
                  {profile.website && (
                    <a href={profile.website} target="_blank" className="text-xs text-purple-600 hover:underline">{profile.website.replace(/https?:\/\/, "")}</a>
                  )}
                </div>
              </div>
            </div>
        ...
        <div className="grid grid-cols-2 md:grid-cols-4 gap-4 mb-6">
          ...
          <div className="bg-white rounded-xl border border-gray-100 shadow-sm p-4 text-center">
            <p className="text-xl font-bold text-green-600">₹{Number(profile.budget)?.toLocaleString() || "—"}</p>
          ...
          <div className="bg-white rounded-2xl shadow-sm border border-gray-100 p-6">
            ...
            <div className="space-y-4">
              ...
              <div>
                ...
                ) : <p className="text-sm text-gray-900">₹{Number(profile.budget)?.toLocaleString() || "—"}</p>}
              </div>
              <div>
          ...
          <div className="bg-white rounded-2xl shadow-sm border border-gray-100 p-6">
            ...
            <div className="space-y-3">
              ...
              <div className="bg-blue-50 rounded-xl p-4 mt-4">
                ...
                <p className="text-sm text-blue-600">Your profile is visible to influencers on the platform. Keep it updated to attract the best talent.</p>
              </div>
