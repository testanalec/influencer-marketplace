      ...
      const response = await fetch("/api/auth/register", {
        ...
        body: JSON.stringify({
          ...
          influencer: {
            ...
            youtubeFollowers: formData.youtubeFollowers ? parseInt(formData.youtubeFollowers) : null,
          ...
          <form onSubmit={handleSubmit} className="space-y-6">
            ...
            <div className="border-b pb-6">
              ...
              <div className="space-y-4">
                <div>
                  ...
                  <textarea name="bio" value={formData.bio} onChange={handleChange} required className="input-field" rows={3} placeholder="Tell us about yourself and your content..." />
                </div>
                <div className="grid grid-cols-1 md:grid-cols-2 gap-4">
                  <div>
                    <label className="form-label">Niche</label>
                    <select name="niche" value={formData.niche} onChange={handleChange} required className="input-field">
                  ...
                  <div>
                    ...
                    <input type="text" name="location" value={formData.location} onChange={handleChange} className="input-field" placeholder="City, Country" />
                  </div>
                </div>
              </div>
            </div>
            ...
            <div className="border-b pb-6">
              ...
              <div className="grid grid-cols-1 md:grid-cols-2 gap-4">
                <div>
                  ...
                  <input type="text" name="instagram" value={formData.instagram} onChange={handleChange} className="input-field" placeholder="@yourhandle" />
                </div>
                <div>
                  <label className="form-label">Instagram Followers</label>
                  <input type="number" name="instagramFollowers" value={formData.instagramFollowers} onChange={handleChange} className="input-field" placeholder="0" />
                </div>
                <div>
                  <label className="form-label">YouTube Channel</label>
                  <input type="text" name="youtube" value={formData.youtube} onChange={handleChange} className="input-field" placeholder="Channel name" />
                </div>
                <div>
                  <label className="form-label">YouTube Followers</label>
                  <input type="number" name="youtubeFollowers" value={formData.youtubeFollowers} onChange={handleChange} className="input-field" placeholder="0" />
                </div>
                <div>
                  <label className="form-label">TikTok Handle</label>
                  <input type="text" name="tiktok" value={formData.tiktok} onChange={handleChange} className="input-field" placeholder="@yourhandle" />
                </div>
                <div>
                  <label className="form-label">TikTok Followers</label>
                  <input type="number" name="tiktokFollowers" value={formData.tiktokFollowers} onChange={handleChange} className="input-field" placeholder="0" />
                </div>
              </div>
            </div>
            ...
            <div>
              ...
              <div>
                ...
                <input type="number" name="ratePerPost" value={formData.ratePerPost} onChange={handleChange} required className="input-field" placeholder="25000" step="1000" min="0" />
              </div>
            </div>
